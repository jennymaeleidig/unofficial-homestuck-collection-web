  ...
  <GenericPage v-if="routeParams.mode == 'artcredits'">
    ...
    <div class="artCredits">
      <div class="centeredProse prose">
        ...
        After the first year of <a href="/mspa/6">Homestuck</a>, starting with
        <a href="/mspa/003701">this page</a>, MSPA began including contributions
        from other artists into the animations. The artists are credited here.
        ...
        <template v-for="(credit, ci) in artCredits">
          <div
            class="artCredit"
            :key="ci"
            v-if="!credit.pages.some(p => $pageIsSpoiler(p))"
          >
    ...
    <div class="card">
      <div class="creditDisambig">
        <div class="creditLinks">
          <div class="credit">
            <a href="/music/features"
              ><Media url="/archive/collection/credits_sound.png" /><br />SOUND
              CREDITS</a
            >
          </div>
          <div class="credit">
            <a href="/credits/artcredits"
              ><Media url="/archive/collection/credits_art.png" /><br />ART
              CREDITS</a
            >
          </div>
        </div>
      ...
      <div class="cardContent">
        <div class="archiveCredits cardBody">
          <div class="title center">
            <h1>The Unofficial Homestuck Collection: Web Edition</h1>
            <p>
              by Bambosh and GiovanH and Jenny
            </p>
          </div>
          ...
          <ul class="thanks">
            <li>
              <a href="https://fontstruct.com/fontstructors/1639437/ducdat0507"
                >ducdat0507</a
              >
              for
              <a
                href="https://fontstruct.com/fontstructions/show/1880599/courierstuck"
                >Courierstuck</a
              >
            </li>
            <li>
              <a href="https://github.com/benwiley4000">Ben Wiley</a> for
              <a href="https://github.com/benwiley4000/gif-frames"
                >gif-frames</a
              >
            </li>
          </ul>
          ...
          <div class="legal prose">
            <pre>
The Unofficial Homestuck Collection: Web Edition is not part of the unofficial-homestuck-collection project and is NOT licensed under GPL3.
    ...
    return {
      archiveCredits: [
        ...
        },
        {
          ...
          desc:
            "For correcting some technical issues and keeping data up-to-date. Thanks also for your work on the hsmusic wiki!"
        },
        {
          name: "Grafcube",
          link: "https://sakurajima.social/@grafcube",
          desc:
            "For leading the initial effort to produce a Flatpak build for linux users"
        },
        {
          name: "Our other GitHub contributors",
          link:
            "https://github.com/GiovanH/unofficial-homestuck-collection/graphs/contributors",
          desc:
            "Every single change you guys make leaves a lasting impact on this project. We wouldn't be here without you!"
        }
      ],
      artCredits: [
        {
        ...
        },
        {
          pages: ["007327"],
          desc:
            'Art contributions from <a href="http://feastings.tumblr.com/" target="_blank">Feastings</a> (character sprites), <a href="http://www.angryturtlegems.com/" target="_blank">Stephen Challener (background sprites)</a>, <a href="http://duedlyfirearms.tumblr.com/" target="_blank">Shelby Cragg (last panel)</a>'
        },
        {
          pages: ["008801"],
          desc:
        ...
        },
        {
          pages: ["008961"],
          desc:
            'By <a href="http://shelbycragg.tumblr.com/" target="_blank">Shelby Cragg</a>'
        },
        {
          pages: ["009349"],
          desc:
        ...
        },
        {
          pages: ["009859"],
          desc:
            'By <a href="http://paperseverywhere.tumblr.com/" target="_blank">Adrienne Garcia</a>, <a href="http://ikimaru.tumblr.com/" target="_blank">Ikimaru</a>, <a href="http://guzusuru.tumblr.com/" target="_blank">Guzusuru</a>, <a href="http://shelbycragg.tumblr.com/" target="_blank">Shelby Cragg</a>, <a href="http://rah-bop.com" target="_blank">Rah-Bop</a>'
        },
        {
          pages: ["009861", "-", "009986"],
        ...
        },
        {
          pages: ["010027"],
          desc:
            'By <a href="http://guzusuru.tumblr.com/" target="_blank">Angela Sham</a>, <a href="http://ani-r.tumblr.com/" target="_blank">Ani Roschier</a>, Jeffrey Lai'
        }
      ]
    };
  },
