  ...
  <div class="pageBody customStyles homepage">
    ...
    <div class="card logoCard">
      ...
      <div class="cardContent collection">
        ...
        <p
          class="versionNotice"
          v-if="$archive.version != $data.$expectedAssetVersion"
        >
          This release of The Unofficial Homestuck Collection: Web Edition is
          tuned around
          <strong>v{{ $data.$expectedAssetVersion }}</strong> of the asset pack,
          but it looks like you're currently on
          <strong>v{{ $archive.version }}</strong
          >.<br /><br />
          Things <em>may</em> still work, but you should probably update<br />
          to asset pack <strong>v{{ $data.$expectedAssetVersion }}</strong> as
          soon as possible.
        </p>
      </div>
    </div>
    <div class="card tight hsCard">
      ...
      <div class="cardContent cardEntry">
        <div class="icon">
          ...
          <img
            src="assets://archive/collection/a6a6_latestpages.png"
            class="a6a6graffiti"
            style="left: 34px; top: 74px;"
            v-if="$root.tabTheme.rendered === 'A6A6'"
          />
        ...
        <div class="description">
          <p>
            <em
              >A story about some kids who are friends over the internet. They
              decide to play a game together. There are major consequences.</em
            >
          </p>
          <br />
          <p>
            The fourth, final, and most famous of the MS Paint Adventures. While
            it began as a "mock-game" following reader commands like the
            previous adventures, they were phased out as the story unfolded into
            a mixed-media barrage of mid-2000's internet culture satire,
            interpersonal drama, and Weird Plot Shit [sic].
          </p>
          <br />
          <p>
            One-upping Problem Sleuth's action-packed GIFs, Homestuck spiced up
            pivotal moments with Flash animations scored by a lively team of
            composers. Over time, the music team produced dozens of albums
          ...
          <div class="links">
            <div class="left bigLink">
              ...
              <br />
              <span v-if="showContinueHomestuck">
                &gt; <a :href="continueHomestuckUrl">Continue</a>
              </span>
            </div>
            <div class="center">
      ...
      <div class="cardContent cardRows">
        ...
        >
          ...
          <p>
            Homestuck was initially intended to be made exclusively in Flash. It
        ...
        <img
          src="assets://archive/collection/a6a6_sponsors.png"
          class="a6a6graffiti"
          style="left: 563px; top: 280px;"
          v-if="$root.tabTheme.rendered === 'A6A6'"
        />
        <HomeRowItem
          class="rowItem"
        ...
        >
          ...
          <p>
            &gt;
            <a href="assets://archive/forum/SBaHJ Origins.html"
              >The origin story.</a
            >
          </p>
        </HomeRowItem>
        ...
        >
          ...
          <p>
            There's this really cool dude, ok? He ran a blog for a while. That's
            really all there is to say on the matter.
          </p>
        </HomeRowItem>
        <HomeRowItem
          class="rowItem"
        ...
        >
          ...
          <p>
            The Squiddles! Sing-Along album came with a flash animation produced
            by the art and music teams.
            <a href="/news/8-26-10">Incredibly silly.</a>
          </p>
        </HomeRowItem>
        <HomeRowItem
          class="rowItem"
        ...
        >
          ...
          <p>
            Date famous Namco characters in this baffling crossover directed by
            Andrew Hussie. Features Homestuck cameos?
          </p>
        </HomeRowItem>
        <HomeRowItem
          class="rowItem"
        ...
        >
          ...
          <p>
            Extra snapshots of life on Earth C, continuing from the credits. No
            longer canon as of The Epilogues.
          </p>
        </HomeRowItem>
        <HomeRowItem
          class="rowItem"
        ...
        >
          ...
          <p>
            Tomorrow's canon, today! Homestuck still has plenty in store for
            you.
          </p>
        </HomeRowItem>
        <HomeRowItem
        ...
        >
          ...
          <p>
            Ten years after their adventure began, the heroes are enjoying a
            well-earned retirement on Earth C. But John still has one last
            choice to make.
          </p>
        </HomeRowItem>
      </div>
    ...
    <div class="card tight" v-if="Object.keys($archive.mspfa).length > 0">
      <div class="cardContent cardEntry">
        ...
        <div class="description">
          ...
          <p>
            Fans began running their own adventures on the MSPA Forums, but with
            the forum format panels and suggestions were mixed together, and
            navigation was an issue. In early 2010, lolzorine and nixshadow set
            up <a href="https://mspfa.com/">MS Paint Fan Adventures</a> as an
            open adventure reader. You can read a brief history
            <a href="https://mspfa.com/history/">on the site</a>.
          </p>
          <br />
          <p>
            With the collapse of the MSPA Forums, MSPFA became the de facto
            source for hosting small adventures. nixshadow retired, and the site
            is currently run by Grant.
          </p>
    ...
    <div class="card mspaCard">
      <Media
        url="/archive/collection/mspa_logo_dark.png"
        class="logo mspaLogo cardContent"
      />
      <div class="cardContent mainSection">
        <div class="cardContent cardEntry jbCard">
          ...
          <div class="description">
            ...
            <p><em href="/mspa/1">A guy tries to escape from prison.</em></p>
            <br />
            <p>
              The very first MS Paint Adventure. Andrew Hussie ran it as a game
              on his personal forum, with a rule that forced him to follow the
              first command suggested after each post. This resulted in barely
              controlled chaos.
            </p>
            <br />
            <p>
              Jailbreak was the origin point of several long running jokes that
              would later return in Homestuck.
            </p>
            <div class="links">> <a href="/log/1">Adventure Log</a></div>
          </div>
        </div>
        <div class="cardContent cardEntry bqCard">
          ...
          <div class="description">
            ...
            <p>
              <em
                >A young bard's endeavor to slay some dragons. Branching "choose
                your own adventure" style.</em
              >
            </p>
            <br />
            <p>
              The second MS Paint Adventure. The branching paths were an
              experiement that ultimately proved too complex to manage, dooming
              it to an early cancellation.
            </p>
            <div class="links">> <a href="/log/2">Adventure Log</a></div>
          </div>
        </div>
        <div class="cardContent cardEntry psCard">
          ...
          <div class="description">
            ...
            <p>
              <em>An adventure about a hard boiled detective in his office.</em>
            </p>
            <br />
            <p>
              The third MS Paint Adventure. An absurd pastiche of adventure
              games and JRPG mechanics, all involving absolutely no detective
              work whatsoever.
            </p>
            <br />
            <p>
              With its rampant escalation of chaos and the gradual inclusion of
              strikingly animated GIFs, Problem Sleuth proved to be MSPA's first
              major hit.
            </p>
            <div class="links">
              <div class="left">
                &gt; <a href="/unlock/PS_titlescreen">Title screen</a>
                <span v-if="showContinueProblemSleuth">
                  <br />
                  &gt;
                  <a :href="continueProblemSleuthUrl">Continue</a>
                </span>
              </div>
              <div class="center">
              ...
              <div class="right">
                &gt;
                <a href="/map/4" v-if="!$pageIsSpoiler('001840')"
                  >Adventure Map</a
                ><a disabled v-else>??????</a>
              </div>
            </div>
      ...
      <div class="cardContent cardRows">
        ...
        >
          ...
          <p>
            Fan-requested commands drawn for fans who made donations. But Andrew
            is no longer doing them. Sorry!
          </p>
        </HomeRowItem>
        <HomeRowItem
          class="rowItem"
        ...
        >
          ...
          <p>
            An explanation of some of the science works in Problem Sleuth. Is
            physics real? Sorta!
          </p>
        </HomeRowItem>
      </div>
    ...
    <div class="card tsoCard">
      <Media
        url="/archive/collection/tso_logo.png"
        class="logo tsoLogo cardContent"
      />
      <div class="cardContent cardEntry tsoCard">
        ...
        <div class="description">
          ...
          <p>
            Before MSPA, Hussie used to maintain a webcomic site, the most
            important comics of which can be found here. Some weren't
            <em>technically</em> part of Team Special Olympics, but that doesn't
            really matter.
          </p>
          <br />
          <p>
            Below, you can find a handful of old blog posts and forum threads
            from around the same time period. Several long-running jokes (such
            as references to Olive Garden and the Saw franchise) originated
            here.
          </p>
        </div>
      </div>
      <div class="cardContent cardRows">
        ...
        >
          ...
          <p>
            Answer one simple question for a FREE* Dinner for Two at Olive
            Garden®!
          </p>
        </HomeRowItem>
        <HomeRowItem
        ...
        >
          <template v-slot:title
            >Come With Me on a Magical Journey Through the Internet!</template
          >
        ...
        >
          ...
          <p>
            HELLO CHEERFULBEAR I WOULD LIKE TO PLAY A GAME HELLO CHEERFULBEAR I
            WOULD
          </p>
        </HomeRowItem>
        ...
        >
          ...
          <p>
            An unfinished book draft of a book about wizards and fanciful
            magicks. Last revised July 2008, discovered December 2012.
          </p>
        </HomeRowItem>
      </div>
    </div>
    ...
    <div class="card newsCard">
      <div class="logo newsLogo cardContent">
        ...
        <img
          src="assets://archive/collection/a6a6_news.png"
          class="a6a6graffiti"
          v-if="$root.tabTheme.rendered === 'A6A6'"
        />
      </div>
      <div class="cardContent">
        <div class="description">
          <p>
            Throughout the run of MSPA, Andrew Hussie used various means of
            communicating with fans. The "news blurb" lasted the full run of the
            site, while others ran at different times.
          </p>
        </div>
      </div>
      <div class="cardContent cardRows">
        ...
        >
          ...
          <p>
            An archive of official newsposts, ranging the entire lifespan of the
            MSPA website.
          </p>
        </HomeRowItem>
        <HomeRowItem
        ...
        >
          ...
          <p>
            Used by Andrew Hussie for behind the scenes commentary during the
            early days of Homestuck.
          </p>
        </HomeRowItem>
        <HomeRowItem
          class="rowItem"
        ...
        >
          ...
          <p>
            Q&As with Andrew Hussie, providing context and commentary on
            Homestuck until it was dropped in mid-2011.
          </p>
        </HomeRowItem>
        <HomeRowItem
          class="rowItem"
        ...
        >
          ...
          <p>
            Picked up in place of Formspring. Used mainly for announcements and
            Q&As, then abandoned in 2013.
          </p>
        </HomeRowItem>
      </div>
    </div>
    ...
    <div class="card unsortedCard noHeaderCard">
      <div class="cardContent cardRows">
        ...
        >
          ...
          <p>
            A collection of wallpapers that was maintained during the first few
            months of Homestuck.
          </p>
        </HomeRowItem>
        <HomeRowItem
        ...
        >
          ...
          <p>
            After the MSPA Forums banned a certain "genre" of fanart, this was
            created by Toby Fox as an act of rebellion.
          </p>
        </HomeRowItem>
        <HomeRowItem
          class="rowItem"
        ...
        >
          ...
          <p>
            <a href="https://www.qwantz.com">Ryan North</a> has had enough of
            Andrew Hussie's lies. Join him on his quest to do... something.
          </p>
        </HomeRowItem>
      </div>
    </div>
...
export default {
  ...
  computed: {
    modHomeRowItems() {
      return this.$archive.tweaks.modHomeRowItems || [];
    },
    mspfaLinks: MSPFAIndex.computed.mspfaLinks,
    showContinueHomestuck() {
      // Only show if progress is selected as Homestuck and current is above 1901
      const settings = this.$localData?.settings;
      const current = settings?.newReader?.current;
      // Debug log for diagnosis
      // eslint-disable-next-line no-console
      // Only show if current is set and above 1901
      const num = parseInt(current, 10);
      if (!num || isNaN(num) || num <= 1901) return false;
      return true;
    },
    showContinueProblemSleuth() {
      const settings = this.$localData?.settings;
      const current = settings?.newReader?.current;
      const num = parseInt(current, 10);
      // Problem Sleuth starts at 219, only show if current is above 219 and below 1901
      if (!num || isNaN(num) || num <= 219 || num >= 1901) return false;
      return true;
    },
    continueProblemSleuthUrl() {
      const current = this.$localData?.settings?.newReader?.current;
      if (!current) return "";
      // Always use MSPA mode for Problem Sleuth
      return this.$resolvePath(`/mspa/${current}`);
    },
    continueHomestuckUrl() {
      // Build the correct route for the current page before resolving
      const current = this.$localData?.settings?.newReader?.current;
      if (!current) return "";
      const mspaMode = this.$localData?.settings?.mspaMode;
      if (mspaMode) {
        return this.$resolvePath(`/mspa/${current}`);
      } else {
        // Use $mspaToViz to get the correct viz page number
        const viz = this.$mspaToViz(current);
        if (viz && viz.s === "homestuck" && viz.p) {
          return this.$resolvePath(`/homestuck/${viz.p}`);
        }
        // fallback
        return this.$resolvePath(`/homestuck/1`);
      }
    }
  },
  methods: {}
