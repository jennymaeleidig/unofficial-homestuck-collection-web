(() => {
  ...
  var e,
    ...
    t = {
      ...
      791: (e, n, t) => {
        e.exports = t.p + "e6c08a4d57d1c54d19e9.wasm";
      },
      797: (e, n, t) => {
        e.exports = t.p + "50d525485bae59fdd025.wasm";
      }
    },
    a = {};
  function r(e) {
  ...
  (r.m = t),
    ...
    (r.u = e =>
      "core.ruffle." +
      { 69: "cc1aa67dae49c28fd82f", 655: "2225ca69a4594bf6772e" }[e] +
      ".js"),
    (r.g = (function() {
  ...
  function h() {
    ("function" == typeof Array.prototype.reduce &&
      ...
      ("function" == typeof Window && p(Window)) ||
        ("function" == typeof window.constructor &&
          p(window.constructor) &&
    ...
    null === v &&
      (v = (async function(e) {
        ...
        n ||
          ...
          ra.options.onFirstLoad?.(),
          (ra.options.onFirstLoad = () => {});
        const { default: t, RuffleInstanceBuilder: a, ZipWriter: o } = await (n
  ...
  function j(e, n, t) {
    return n[t]
      ? q(e, n[t].value)
      : (e.reportError(new RangeError("No default")), new w());
  }
  function E(e, n) {
    const t = [],
      a = Object.create(null);
    for (const r of n)
      "narg" === r.type ? (a[r.name] = C(e, r.value)) : t.push(C(e, r));
  ...
  function C(e, n) {
    switch (n.type) {
      case "str":
        return n.value;
      case "num":
        return new k(n.value, { minimumFractionDigits: n.precision });
      case "var":
      ...
      case "term":
        return (function(e, { name: n, attr: t, args: a }) {
          ...
          if (!o)
            return (
              e.reportError(new ReferenceError(`Unknown term: ${r}`)), new w(r)
            );
          if (t) {
      ...
      case "select":
        return (function(e, { selector: n, variants: t, star: a }) {
          let r = C(e, n);
          if (r instanceof w) return j(e, t, a);
          for (const n of t) {
            if (S(e, r, C(e, n.key))) return q(e, n.value);
          }
          return j(e, t, a);
        })(e, n);
      default:
  ...
  function A(e, n) {
    if (e.dirty.has(n))
      return e.reportError(new RangeError("Cyclic reference")), new w();
    e.dirty.add(n);
    const t = [],
      a = e.bundle._useIsolating && n.length > 1;
    for (const r of n)
      if ("string" != typeof r) {
        if ((e.placeables++, e.placeables > R))
          throw (e.dirty.delete(n),
          new RangeError(
            `Too many placeables expanded: ${e.placeables}, max allowed is ${R}`
          ));
  ...
  function P(e, n) {
    ...
    if (t instanceof k) return new k(t.valueOf(), { ...t.opts, ...D(n, O) });
    if (t instanceof y) return new k(t.valueOf(), { ...D(n, O) });
  ...
  function M(e, n) {
    ...
    if (t instanceof y) return new y(t.valueOf(), { ...t.opts, ...D(n, $) });
    if (t instanceof k) return new y(t.valueOf(), { ...D(n, $) });
  ...
  class T {
    constructor(
      ...
      (this._terms = new Map()),
        ...
        (this._functions = { NUMBER: P, DATETIME: M, ...n }),
    ...
    formatPattern(e, n = null, t = null) {
      ...
      try {
        ...
        if (a.errors && e instanceof Error)
          return a.errors.push(e), new w().toString(a);
        throw e;
      }
    }
  }
  ...
  class ue {
    constructor(e) {
      ...
      function l() {
        let a;
        if ((t(H) && (a = i(H)), "{" === e[n] || "}" === e[n]))
          return u(a ? [a] : [], 1 / 0);
        let r = b();
        return r
          ? a
            ? u([a, r], r.length)
            : ((r.value = g(r.value, G)), u([r], r.length))
          : a
          ? g(a, Q)
          : null;
      }
      function u(a = [], r) {
        ...
        let l = [];
        for (let e of a)
          e instanceof ce && (e = e.value.slice(0, e.value.length - r)),
            e && l.push(e);
        return l;
      }
      function c() {
        ...
        if (r(oe)) {
          ...
          return r(ne, SyntaxError), { type: "select", selector: e, ...n };
        }
  ...
  class fe {
    ...
    addLikelySubtags() {
      const e = (function(e) {
        ...
        const n = new fe(e);
        if (n.language && pe.includes(n.language))
  ...
  function he(e, n, { strategy: t = "filtering", defaultLocale: a } = {}) {
  ...
  for (const [e, n] of Object.entries(ve)) {
    ...
    if (n)
      for (const [a, r] of Object.entries(n))
        if (r)
          for (const n of t.addResource(new ue(r)))
  ...
  function ye(e, n, t, a, r) {
    const o = r ? document.createElementNS(r, e) : document.createElement(e);
    if (
      (n && (o.id = n), t && r ? o.classList.add(t) : t && (o.className = t), a)
    )
      for (const [e, n] of Object.entries(a)) o.setAttribute(e, n);
    return o;
  }
  function Re(e, n, t, a, r) {
    const o = ye("input", n);
    return (
      (o.type = e), t && (o.min = t), a && (o.max = a), r && (o.step = r), o
    );
  }
  function xe(e, n) {
    const t = ye("label", e);
  ...
  const Se = document.createElement("template"),
    ...
    Ee = ye("style", "static-styles"),
    Ce = ye("style", "dynamic-styles"),
    Ae = ye("div", "container"),
    qe = ye("div", "play-button"),
    Fe = ye("div", void 0, "icon"),
    De = ye(
      "svg",
      void 0,
      void 0,
    ...
    Oe = ye("defs", void 0, void 0, void 0, je),
    Pe = ye(
      "linearGradient",
      "a",
      void 0,
    ...
    We = document.createElementNS(je, "use");
  We.href.baseVal = "#b";
  const _e = ye("div", "unmute-overlay"),
    Ue = ye("div", void 0, "background"),
    Ne = ye("div", void 0, "icon"),
    Be = ye(
      "svg",
      "unmute-overlay-svg",
      void 0,
    ...
    Ke = ye("input", "virtual-keyboard", void 0, {
      type: "text",
      autocapitalize: "off",
      autocomplete: "off",
      autocorrect: "off"
    }),
    Ge = ye("div", "splash-screen", "hidden"),
    Qe = ye(
      "svg",
      void 0,
      "logo",
    ...
    Ye = ye("g", void 0, void 0, void 0, je),
    Xe = ye(
      "path",
      void 0,
      void 0,
    ...
    an = ye("div", void 0, "loadbar"),
    rn = ye("div", void 0, "loadbar-inner"),
    on = ye("div", "save-manager", "modal hidden"),
    sn = ye("div", "modal-area", "modal-area"),
    ln = ye("span", void 0, "close-modal"),
    un = ye("div", void 0, "general-save-options"),
    cn = ye("span", void 0, "modal-button"),
    dn = ye("table", "local-saves"),
    fn = ye("div", "volume-controls-modal", "modal hidden"),
    mn = ye("div", void 0, "modal-area"),
    pn = ye("div", "volume-controls"),
    hn = Re("checkbox", "mute-checkbox"),
    vn = Re("range", "volume-slider", "0", "100", "1"),
    bn = xe("volume-mute", "mute-checkbox");
  bn.title = we("volume-controls-unmute");
  const gn = xe("volume-min", "mute-checkbox"),
    wn = xe("volume-mid", "mute-checkbox"),
    kn = xe("volume-max", "mute-checkbox");
  [gn, wn, kn].forEach(e => (e.title = we("volume-controls-mute")));
  const yn = ye("span", "volume-slider-text"),
    Rn = ye("span", void 0, "close-modal"),
    xn = ye("div", "video-modal", "modal hidden"),
    zn = ye("div", void 0, "modal-area"),
    Sn = ye("span", void 0, "close-modal"),
    jn = ye("div", "video-holder"),
    En = ye("div", "hardware-acceleration-modal", "modal hidden"),
    Cn = ye("div", void 0, "modal-area"),
    An = ye("span", void 0, "close-modal"),
    qn = ye("span", "acceleration-text");
  qn.textContent = we("enable-hardware-acceleration");
  ...
  (Fn.href =
    ...
    (Fn.target = "_blank"),
    (Fn.className = "modal-button"),
    (Fn.textContent = we("enable-hardware-acceleration-link"));
  const Dn = ye("div", "clipboard-modal", "modal hidden"),
    On = ye("div", void 0, "modal-area"),
    Pn = ye("span", void 0, "close-modal"),
    $n = ye("h2", void 0);
  $n.textContent = we("clipboard-message-title");
  const Mn = ye("p", "clipboard-modal-description"),
    In = navigator.userAgent.includes("Mac OS X") ? "Command" : "Ctrl",
    Tn = ye("p", void 0),
    Ln = ye("b", void 0);
  Ln.textContent = `${In}+C`;
  const Wn = ye("span", void 0);
  Wn.textContent = we("clipboard-message-copy");
  const _n = ye("p", void 0),
    Un = ye("b", void 0);
  Un.textContent = `${In}+X`;
  const Nn = ye("span", void 0);
  Nn.textContent = we("clipboard-message-cut");
  const Bn = ye("p", void 0),
    Jn = ye("b", void 0);
  Jn.textContent = `${In}+V`;
  const Hn = ye("span", void 0);
  Hn.textContent = we("clipboard-message-paste");
  const Vn = ye("div", "context-menu-overlay", "hidden"),
    Zn = ye("ul", "context-menu");
  ze(Se.content, Ee),
    ze(Se.content, Ce),
    ze(Se.content, Ae),
    ze(Ae, qe),
      ...
      for (; a < 999; ) {
        ...
        if (
          ...
          return (
            ...
            (Kn[e] = { class: n, name: t, internalName: e }),
            t
          );
        a += 1;
      }
  ...
  var Qn, Yn, Xn, et, nt, tt, at, rt, ot, it;
  !(function(e) {
  ...
  const st = {
      ...
      letterbox: Yn.Fullscreen,
      unmuteOverlay: Xn.Visible,
      upgradeToHttps: !0,
      ...
      openUrlMode: ot.Allow,
      allowNetworking: it.All,
      openInNewTab: null,
      socketProxy: [],
      fontSources: [],
      defaultFonts: {},
      credentialAllowList: [],
      playerRuntime: rt.FlashPlayer
    },
    lt = "application/x-shockwave-flash",
    ut = "application/futuresplash",
    ct = "application/x-shockwave-flash2-preview",
    dt = "application/vnd.adobe.flash.movie";
  function ft(e, n) {
    const t = (function(e) {
      let n = "";
      try {
  ...
  try {
    if (
      ...
      e.endsWith(".js") || e.endsWith("/") || (e += "/"),
        (pt = new URL(".", e)),
        (ht = pt.protocol.includes("extension"));
    }
  } catch (e) {
  ...
  function bt(e, n) {
    if (
      (vt(n.allowScriptAccess) && e.setAllowScriptAccess(n.allowScriptAccess),
      vt(n.backgroundColor) &&
      ...
      vt(n.upgradeToHttps) && e.setUpgradeToHttps(n.upgradeToHttps),
      vt(n.compatibilityRules) && e.setCompatibilityRules(n.compatibilityRules),
      vt(n.letterbox) && e.setLetterbox(n.letterbox.toLowerCase()),
      vt(n.base) && e.setBaseUrl(n.base),
      vt(n.menu) && e.setShowMenu(n.menu),
      vt(n.allowFullscreen) && e.setAllowFullscreen(n.allowFullscreen),
      vt(n.salign) && e.setStageAlign(n.salign.toLowerCase()),
      vt(n.forceAlign) && e.setForceAlign(n.forceAlign),
      vt(n.quality)
        ...
        : void 0 !== window.orientation &&
          ...
          e.setQuality("low")),
      vt(n.scale) && e.setScale(n.scale.toLowerCase()),
      vt(n.forceScale) && e.setForceScale(n.forceScale),
      vt(n.frameRate) && e.setFrameRate(n.frameRate),
      vt(n.wmode) && e.setWmode(n.wmode),
      vt(n.logLevel) && e.setLogLevel(n.logLevel),
      vt(n.maxExecutionDuration) &&
      ...
      vt(n.playerVersion) && e.setPlayerVersion(n.playerVersion),
      vt(n.preferredRenderer) && e.setPreferredRenderer(n.preferredRenderer),
      vt(n.openUrlMode) && e.setOpenUrlMode(n.openUrlMode.toLowerCase()),
      vt(n.allowNetworking) &&
        e.setAllowNetworking(n.allowNetworking.toLowerCase()),
      vt(n.credentialAllowList) &&
        e.setCredentialAllowList(n.credentialAllowList),
      vt(n.playerRuntime) && e.setPlayerRuntime(n.playerRuntime),
      vt(n.socketProxy))
    )
  ...
  const St = {
    ...
    createReportOrUpdate() {
      return zt() ? this.UpdateRuffle : this.CreateReport;
    },
    openWiki: (e, n) => ({
      type: "open_link",
    ...
    let { body: o, actions: i } = (function(e) {
      if (e instanceof kt)
        return e.swfUrl && !e.swfUrl.protocol.includes("http")
          ? {
              ...
              actions: [St.OpenDemo, St.DownloadDesktop]
            }
          : window.location.origin === e.swfUrl?.origin ||
            window.location.protocol.includes("extension")
          ? { body: ke("error-swf-fetch"), actions: [St.ShowDetails] }
          : {
              body: ke("error-swf-cors"),
              actions: [
                St.openWiki("Using-Ruffle#configure-cors-header"),
                St.ShowDetails
              ]
            };
      if (e instanceof yt)
        return { body: ke("error-invalid-swf"), actions: [St.ShowDetails] };
      if (e instanceof Rt) {
        ...
        if (n.includes("mime"))
          return {
            ...
            actions: [
              St.openWiki("Using-Ruffle#configure-webassembly-mime-type"),
              St.ShowDetails
            ]
          };
        ...
        if (n.includes("disallowed by embedder"))
          return {
            ...
            actions: [
              St.openWiki("Using-Ruffle#configure-wasm-csp"),
              St.ShowDetails
            ]
          };
        if ("CompileError" === e.cause.name)
          return {
            ...
            actions: [
              St.openWiki("Using-Ruffle#addressing-a-compileerror"),
              St.ShowDetails
            ]
          };
        if (
          ...
          return { body: ke("error-wasm-download"), actions: [St.ShowDetails] };
        if ("TypeError" === e.cause.name) {
          const e = ke("error-javascript-conflict");
          return (
            zt() &&
              e.appendChild(
                ke("error-javascript-conflict-outdated", {
                  buildDate: mt.buildDate
                })
              ),
            { body: e, actions: [St.createReportOrUpdate(), St.ShowDetails] }
          );
        }
        return navigator.userAgent.includes("Edg") &&
          ...
          : {
              ...
              actions: [
                St.openWiki("Using-Ruffle#configuration-options"),
                St.ShowDetails
              ]
            };
      }
      return e instanceof xt
        ? {
            ...
            actions: [
              St.openWiki("Using-Ruffle#javascript-api"),
              St.ShowDetails
            ]
          }
        : {
            ...
            actions: [St.createReportOrUpdate(), St.ShowDetails]
          };
    })(n);
    const s = (0, gt.createRef)(),
      u = () => {
        s.current.classList.add("details"),
          s.current.replaceChildren(
            (0, l.jsx)("textarea", { readOnly: !0, children: r })
          );
      };
    (e.textContent = ""),
      e.appendChild(
        (0, l.jsxs)("div", {
          ...
          children: [
            ...
            (0, l.jsx)("div", { id: "panic-body", ref: s, children: o }),
            (0, l.jsx)("div", {
              id: "panic-footer",
              children: (0, l.jsx)("ul", {
                children: i.map(e =>
  ...
  class Ft extends HTMLElement {
    ...
    constructor() {
      super(),
        ...
        this.shadow.appendChild(Se.content.cloneNode(!0)),
        ...
        (this.volumeSettings = new Lt(!1, 100)),
      ...
      e &&
        ...
        (e.innerText = we("save-backup-all")));
      ...
      (this.contextMenuOverlay = this.shadow.getElementById(
        ...
        (this._readyState = Dt.HaveNothing),
        (this._metadata = null),
    ...
    async ensureFreshInstance() {
      ...
      const [e, n] = await b(this.onRuffleDownloadProgress.bind(this)).catch(
        e => {
      ...
      if (
        ...
        !this.loadedConfig ||
          this.loadedConfig.autoplay === Qn.On ||
          (this.loadedConfig.autoplay !== Qn.Off &&
            "running" === this.audioState()))
      ) {
        if ((this.play(), "running" !== this.audioState())) {
          (this.loadedConfig &&
            this.loadedConfig.unmuteOverlay === Xn.Hidden) ||
        ...
        if (!Tt(this))
          try {
            (this.loadedConfig = {
              ...st,
              ...(n && "url" in e
                ? { allowScriptAccess: Pt("samedomain", e.url) }
                : {}),
              ...
              this.loadedConfig.backgroundColor &&
                this.loadedConfig.wmode !== nt.Transparent &&
              ...
              "url" in e
                ? (console.log(`Loading SWF file ${e.url}`),
                  ...
                  this.instance.stream_from(this.swfUrl.href, At(e.parameters)))
                : "data" in e &&
    ...
    confirmReloadSave(e, n, t) {
      if (this.isB64SOL(n) && localStorage[e]) {
        ...
        if (a.includes(o) && e.startsWith(r)) {
          return void (
            confirm(
              we("save-reload-prompt", { action: t ? "replace" : "delete" })
            ) &&
            this.loadedConfig &&
            (this.destroy(),
    ...
    pointerDown(e) {
      (this.pointerDownPosition = new qt(e.pageX, e.pageY)),
        (this.pointerMoveMaxDistance = 0),
    ...
    checkLongPressMovement(e) {
      if (null !== this.pointerDownPosition) {
        const n = new qt(e.pageX, e.pageY),
      ...
      if (
        ("contextmenu" === e.type
          ...
          : (document.documentElement.addEventListener(
            ...
            e.stopPropagation()),
        [!1, at.Off].includes(this.loadedConfig?.contextMenu ?? at.On) ||
          (this.isTouch &&
            this.loadedConfig?.contextMenu === at.RightClickOnly) ||
    ...
    getPanicData() {
      let e = "\n# Player Info\n";
      if (
        ((e += `Allows script access: ${!!this.loadedConfig &&
    ...
    panic(e) {
      ...
      const n = Object.assign([], { stackIndex: -1, avmStackIndex: -1 });
      if ((n.push("# Error Info\n"), e instanceof Error)) {
        if (
          (n.push(`Error name: ${e.name}\n`),
      ...
      n.push(this.getPanicData()),
        jt(this.container, e, n, this.swfUrl),
        this.destroy();
    }
    addOpenInNewTabMessage(e, n) {
      const t = new URL(n);
      if (this.loadedConfig?.parameters) {
        const e = At(this.loadedConfig?.parameters);
      ...
      (i.innerText = we("open-in-new-tab")),
        (i.onclick = () => e(t)),
        o.appendChild(i),
        r.appendChild(o),
        a.appendChild(r),
    ...
    displayRootMovieDownloadFailedMessage(e) {
      ...
      if (n && this.swfUrl && window.location.origin !== this.swfUrl.origin)
        ...
        const n = e ? new yt(this.swfUrl) : new kt(this.swfUrl);
        this.panic(n);
      }
    }
    displayMessage(e) {
    ...
    displayClipboardModal(e) {
      ...
      n &&
        ((n.textContent = we("clipboard-message-description", {
    ...
    setMetadata(e) {
      (this._metadata = e),
        (this._readyState = Dt.Loaded),
        this.hideSplashScreen(),
        this.dispatchEvent(new CustomEvent(Ft.LOADED_METADATA)),
        this.dispatchEvent(new CustomEvent(Ft.LOADED_DATA));
    }
    PercentLoaded() {
      return this._readyState === Dt.Loaded ? 100 : 0;
    }
  }
  var Dt;
  function Ot(e) {
  ...
  function $t(e, n) {
    ...
    const r = Pt(n("allowScriptAccess"), e);
  ...
  class Wt extends Ft {
    ...
    static isInterdictable(e) {
      ...
      return !!n && !Tt(e) && (Mt(n) ? (It(e, "src"), !1) : ft(n, t));
    }
    static fromNativeEmbedElement(e) {
      const n = Gn("ruffle-embed", Wt),
  ...
  class Ut extends Ft {
    ...
    connectedCallback() {
      super.connectedCallback(), (this.params = _t(this));
      let e = null;
      if (
  ...
  const Ht = window.RufflePlayer?.config ?? {},
    Vt =
      (function(e) {
        let n = pt?.href ?? "";
        return (
  ...
  function Yt() {
    return (
      (!("favorFlash" in Ht) || !1 !== Ht.favorFlash) &&
      "ruffle.js" !==
  ...
  function Xt() {
    try {
      (Zt = Zt ?? document.getElementsByTagName("object")),
        (Kt = Kt ?? document.getElementsByTagName("embed"));
      for (const e of Array.from(Zt))
        if (Ut.isInterdictable(e)) {
          const n = Ut.fromNativeObjectElement(e);
          e.replaceWith(n);
        }
      for (const e of Array.from(Kt))
  ...
  function ea() {
    (Gt = Gt ?? document.getElementsByTagName("iframe")),
      (Qt = Qt ?? document.getElementsByTagName("frame")),
      [Gt, Qt].forEach(e => {
        for (const n of e) {
          ...
          try {
            "complete" === e.document.readyState && na(e, t);
          } catch (e) {
            ht || console.warn(t + e);
          }
          n.addEventListener(
  ...
  async function na(e, n) {
    ...
    try {
      ...
      return void (ht || console.warn(n + e));
    }
    if (ht || void 0 === t.documentElement.dataset.ruffleOptout)
      if (ht)
        e.RufflePlayer || (e.RufflePlayer = {}),
          (e.RufflePlayer.config = { ...Ht, ...(e.RufflePlayer.config ?? {}) });
      else if (!e.RufflePlayer) {
        const n = t.createElement("script");
        n.setAttribute("src", Vt),
          (n.onload = () => {
            (e.RufflePlayer = {}), (e.RufflePlayer.config = Ht);
          }),
      ...
      (function(e) {
        ("install" in navigator.plugins && navigator.plugins.install) ||
          Object.defineProperty(navigator, "plugins", {
            value: new Bt(navigator.plugins),
            writable: !1
          }),
          ...
          !(e.length > 0) ||
            ...
            Object.defineProperty(navigator, "mimeTypes", {
              value: new Nt(navigator.mimeTypes),
              writable: !1
            });
  ...
  const ra = {
    version: mt.versionNumber + "+" + mt.buildDate.substring(0, 10),
    polyfill() {
      aa();
    },
    pluginPolyfill() {
