module.exports = {
  ...
  routes: {
    ...
    "assets://newspost_images/scarecrowking1.gif":
      "assets://archive/social/news/scarecrowking1.gif",
    "assets://newspost_images/scarecrowking2.gif":
      "assets://archive/social/news/scarecrowking2.gif"
  },
  edit: true,
    ...
    return {
      edit(archive) {
        ...
        function editFormspring(group, id, pattern, substitution) {
          const match = archive.social.formspring[group].find(
            (p, i) => p.id === id
          );
          archive.social.formspring[group].find(
            (p, i) => p.id === id
          ).html = match.html.replace(pattern, substitution);
        }
        ...
        archive.mspa.story["004153"].content = archive.mspa.story[
          "004153"
        ].content.replace(
        ...
        archive.mspa.story["005530"].content = archive.mspa.story[
          "005530"
        ].content.replace(
          `<span style="color: #2ed73a">L</span><img src="http://www.mspaintadventures.com/storyfiles/hs2/scraps/o.gif" border="0" /><span style="color: #2ed73a">rd English</span>`,
          `<span style="color: #2ed73a; white-space: nowrap">L<img src="assets://storyfiles/hs2/scraps/o.gif" border="0">rd English</span>`
        ...
        archive.comics.pxs.comics[
          "you-have-a-feeling-its-going-to-be-a-long-day"
        ].credit = "Zach Morrison and Andrew Hussie";

        archive.social.blogspot[8].html = archive.social.blogspot[8].html.replace(
          "archive/tso/blurbs",
          "archive/comics/tso/blurbs"
        );

        editFormspring(
          "andrewhussie",
          "andrewhussie550488999",
          '"/archive/formspring/00958_1.gif"',
          '"assets://archive/social/formspring/00958_1.gif"'
        );
