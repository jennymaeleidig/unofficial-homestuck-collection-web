...
const new_issue_link =
  "https://github.com/giovanh/unofficial-homestuck-collection/issues/new";

const error_dialog_msg =
  "If you think this is an error in the application, you can submit a bug report:";
