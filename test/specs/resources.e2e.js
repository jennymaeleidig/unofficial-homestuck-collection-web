...
async function testArchiveMusic() {
  ...
  // from discography.vue
  const album_urls = Object.values(archive.music.albums).map(
    album => `assets://archive/music/${album.directory}/cover.jpg`
  );
  album_urls.push(`assets://archive/music/spoiler.png`);

  await Promise.all(
    album_urls.map(u =>
      fetch(Resources.resolveAssetsProtocol(u), { mode: "no-cors" })
    )
  );
  logger.info("Done (opaque)");
  ...
  const track_urls = Object.values(archive.music.tracks).map(track => {
    const dirName =
      track.album.find(album => archive.music.albums[album].hasTrackArt) ||
      track.album[0];
    const fileName =
      track.coverArtists && archive.music.albums[dirName].hasTrackArt
        ? track.directory
        : "cover";
...
async function testArchiveComic(archive) {
  ...
  // from discography.vue
  const media_urls = Object.values(archive.mspa.story).reduce(
    (acc, page) => [...acc, ...page.media],
    []
  );
  ...
  for (let i = 0; i < array.length; i += chunk_size) {
    ...
    await Promise.all(
      chunk.map(u => fetch(getResourceURL(u), { mode: "no-cors" }))
    );
    logger.info(i);
  }
  logger.info("Done (opaque)");
...
const libGetResourceUrl = {
  "http://www.turner.com/planet/mp3/cp_close.mp3":
    "assets://storyfiles/hs2/00338/cp_close.mp3",
  "http://fozzy42.com/SoundClips/Themes/Movies/Ghostbusters.mp3":
    "assets://storyfiles/hs2/00338/Ghostbusters.mp3",
  "http://pasko.webs.com/foreign/Aerosmith_-_I_Dont_Wanna_Miss_A_Thing.mp3":
    "assets://storyfiles/hs2/00338/Aerosmith_-_I_Dont_Wanna_Miss_A_Thing.mp3",
  "http://www.mspaintadventures.com/extras/ps000015.html": "/unlock/ps000015",
  "/advimgs/jb/mspaintadventure08.gif":
    "assets://advimgs/jb/mspaintadventure08.gif",
  "/archive/collection/archive_beta.png":
    "assets://archive/collection/archive_beta.png",
  "/archive/collection/archive_vigilprince.png":
    "assets://archive/collection/archive_vigilprince.png",
  "/archive/collection/mspa_logo_dark.png":
    "assets://archive/collection/mspa_logo_dark.png",
  "/archive/collection/tso_logo.png":
    "assets://archive/collection/tso_logo.png",
  "/archive/music/bannerCrop.png": "assets://archive/music/bannerCrop.png",
  "/archive/music/homestuck-vol-5/cover.jpg":
    "assets://archive/music/homestuck-vol-5/cover.jpg",
  ...
  "/archive/namcohigh/logo_namcohigh_tm.png":
    "assets://archive/namcohigh/logo_namcohigh_tm.png",
  "/archive/namcohigh/recommend_left_btn.png":
    "assets://archive/namcohigh/recommend_left_btn.png",
  "/archive/namcohigh/recommend_right_btn.png":
    "assets://archive/namcohigh/recommend_right_btn.png",
  "/archive/namcohigh/text_artist_01.png":
    "assets://archive/namcohigh/text_artist_01.png",
  "/archive/namcohigh/text_lead.png":
    "assets://archive/namcohigh/text_lead.png",
  ...
  "/storyfiles/hs2/05260/05260.html":
    "assets://storyfiles/hs2/05260/05260.html",
  "/storyfiles/hs2/07631.gif": "assets://storyfiles/hs2/07631.gif",
  "/storyfiles/hs2/08112johndad.png":
    "http://homestuck.com/mspa?s=6&p=007395",
  "http://homestuckgaiden.bandcamp.com/":
    "http://homestuckgaiden.bandcamp.com/",
  "http://i2.photobucket.com/albums/y25/Agrajag42/mspa/MC-timeline-page1.png":
    "http://i2.photobucket.com/albums/y25/Agrajag42/mspa/MC-timeline-page1.png",
  "http://i2.photobucket.com/albums/y25/Agrajag42/mspa/MC-timeline-page2.png":
    "http://i2.photobucket.com/albums/y25/Agrajag42/mspa/MC-timeline-page2.png",
  ...
  "http://localhost:8080/archive/external/midnightcrew.mp4":
    "assets://archive/external/midnightcrew.mp4",
  "http://localhost:8080/archive/external/miracles.mp4":
    "assets://archive/external/miracles.mp4",
  "http://localhost:8080/archive/external/mspa-record.gif":
    "assets://archive/external/mspa-record.gif",
  "http://localhost:8080/archive/social/news/v2_a_ps.gif":
    "assets://archive/social/news/v2_a_ps.gif",
  "http://localhost:8080/archive/social/news/vol5_album_banner.gif":
    "assets://archive/social/news/vol5_album_banner.gif",
  "http://localhost:8080/blogspot/end-of-problem-sleuth":
    "http://localhost:8080/blogspot/end-of-problem-sleuth",
  "http://localhost:8080/blogspot/soul-money":
    "http://localhost:8080/blogspot/soul-money",
  "http://localhost:8080/credits": "http://localhost:8080/credits",
  "http://localhost:8080/credits/artcredits":
    "http://localhost:8080/credits/artcredits",
  "http://localhost:8080/credits/soundcredits":
    "http://localhost:8080/credits/soundcredits",
  "http://localhost:8080/evenmore": "http://localhost:8080/evenmore",
  "http://localhost:8080/formspring": "http://localhost:8080/formspring",
  "http://localhost:8080/music/album/homestuck-vol-5":
    "http://localhost:8080/music/album/homestuck-vol-5",
  "http://localhost:8080/music/album/midnight-crew-drawing-dead":
    "http://localhost:8080/music/album/midnight-crew-drawing-dead",
  "http://localhost:8080/music/album/squiddles":
    "http://localhost:8080/music/album/squiddles",
  "http://localhost:8080/music/artist/bill-bolin":
    "http://localhost:8080/music/artist/bill-bolin",
  "http://localhost:8080/music/track/crystamanthequins":
    "http://localhost:8080/music/track/crystamanthequins",
  "http://localhost:8080/news": "http://localhost:8080/news",
  "http://localhost:8080/news/1-08-10": "http://localhost:8080/news/1-08-10",
  "http://localhost:8080/pxs/summerteen-romance/31":
    "http://localhost:8080/pxs/summerteen-romance/31",
  ...
  "http://localhost:8080/ryanquest/andrewhussie.png":
    "assets://ryanquest/andrewhussie.png",
  ...
  "http://localhost:8080/scraps2/jessfink_soulportrait.jpg":
    "assets://scraps2/jessfink_soulportrait.jpg",
  "http://localhost:8080/scraps2/knockknock.jpg":
    "assets://scraps2/knockknock.jpg",
  "http://localhost:8080/scraps2/sassacre_original.jpg":
    "assets://scraps2/sassacre_original.jpg",
  "http://localhost:8080/scraps2/tcafchillin.jpg":
    "assets://scraps2/tcafchillin.jpg",
  "http://localhost:8080/search": "http://localhost:8080/search",
  "http://localhost:8080/settings": "http://localhost:8080/settings",
    assets_root + "archive/social/news/felt_cover.gif",
  "assets://archive/social/news/icon_clown.gif":
    assets_root + "archive/social/news/icon_clown.gif",
  "assets://archive/social/news/musiclogo_MC.gif":
    assets_root + "archive/social/news/musiclogo_MC.gif",
  "assets://archive/social/news/PSbookphoto.gif":
    assets_root + "archive/social/news/PSbookphoto.gif",
  "assets://archive/social/news/PScover2_thumb.gif":
    assets_root + "archive/social/news/PScover2_thumb.gif",
  "assets://archive/social/news/recordshirt_banner.gif":
    assets_root + "archive/social/news/recordshirt_banner.gif",
  "assets://archive/social/news/SBAHJ_shirtthumb1.gif":
    assets_root + "archive/social/news/SBAHJ_shirtthumb1.gif",
  "assets://archive/social/news/SBAHJ_shirtthumb2.gif":
    assets_root + "archive/social/news/SBAHJ_shirtthumb2.gif",
  "assets://archive/social/news/sburbwallpaper_sm.jpg":
    assets_root + "archive/social/news/sburbwallpaper_sm.jpg",
  "assets://archive/social/news/shirts12-13.jpg":
    assets_root + "archive/social/news/shirts12-13.jpg",
  "assets://archive/social/news/soulportrait_after_th.jpg":
    assets_root + "archive/social/news/soulportrait_after_th.jpg",
  "assets://archive/social/news/squiddles_cover.gif":
    assets_root + "archive/social/news/squiddles_cover.gif",
  "assets://archive/social/news/trollshirts_palette.gif":
    assets_root + "archive/social/news/trollshirts_palette.gif",
  "assets://archive/social/news/v2_a_ps.gif":
    assets_root + "archive/social/news/v2_a_ps.gif",
  "assets://archive/social/news/vol5_album_banner.gif":
    assets_root + "archive/social/news/vol5_album_banner.gif",
  "assets://images/logo.gif": assets_root + "images/logo.gif",
  "assets://images/news.png": assets_root + "images/news.png",
  "assets://ryanquest/andrewhussie.png":
    assets_root + "ryanquest/andrewhussie.png",
  "assets://storyfiles/hs2/05260/05260.html":
    assets_root + "storyfiles/hs2/05260/05260.html",
  "assets://storyfiles/hs2/scraps/smuut25.gif":
    assets_root + "storyfiles/hs2/scraps/smuut25.gif"
};
...
describe("Resources", async () => {
  ...
  describe("path resolution", async () => {
    describe("getResourceURL", async () => {
      await expectMap(libGetResourceUrl, query =>
        Resources.getResourceURL(query)
      );
    });
    ...
    describe("resolveAssetsProtocol", async () => {
      await expectMap(libResolveAssetsProtocol, query =>
        Resources.resolveAssetsProtocol(query)
      );
    });
  });
  ...
  describe("story logic", async () => {
    ...
    describe("getAllPagesInStory", async () => {
      await expectMap(
        libAllPages,
        story => window.vm.$getAllPagesInStory(story, false).length
      );
    });
    describe("getAllPagesInStory inclSecret", async () => {
      await expectMap(
        libAllPagesSec,
        story => window.vm.$getAllPagesInStory(story, true).length
      );
    });
    describe("vizToMspa", async () => {
      await expectMap(libVizToMspa, t => {
        const [b, p] = t.split(" ");
        return JSON.stringify(window.vm.$vizToMspa(b, p));
      });
    });
    describe("mspaToViz", async () => {
      await expectMap(libMspaToViz, p =>
        JSON.stringify(window.vm.$mspaToViz(p))
      );
    });
  });
